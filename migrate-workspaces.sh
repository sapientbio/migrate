...
# Export -> Import
mkdir "${EXPORT_DIR}"
python3 export_db.py --profile "${SOURCE_PROFILE}" --workspace --download --set-export-dir "${EXPORT_DIR}"
python3 import_db.py --profile "${TARGET_PROFILE}" --workspace --set-export-dir "${EXPORT_DIR}" --archive-missing
